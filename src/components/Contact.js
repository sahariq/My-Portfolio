        ...
        <div className="md:flex md:space-x-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              ...
              reach out through the contact form or connect with me directly through my social
              profiles.
            </p>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {formStatus.message && (
                <div className={`p-3 rounded-lg ${formStatus.error ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                  {formStatus.message}
                </div>
              )}
