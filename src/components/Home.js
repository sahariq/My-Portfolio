        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="h-56 bg-gradient-to-r from-primary-100 to-primary-200 flex items-center justify-center relative overflow-hidden">
                <span className="text-gray-400 z-10">Project Image</span>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {project.techStack.map((tech) => (
                    <span 
                      key={tech} 
                      className="px-2.5 py-1 bg-gray-100 text-gray-700 text-xs rounded-full hover:bg-primary-100 hover:text-primary-600 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
